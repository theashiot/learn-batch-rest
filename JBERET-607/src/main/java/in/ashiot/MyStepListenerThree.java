...
@Dependent
@Named("MyStepListenerThree")
public class MyStepListenerThree implements StepListener{
    ...
    private static final Logger LOGGER = Logger.getLogger(MyStepListenerThree.class);
